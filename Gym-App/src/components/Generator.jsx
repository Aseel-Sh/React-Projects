...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id={'generate'} header={"generate your workout"} title={['It\'s', 'Huge', 'o\'clock']}>
            ...
            <Header index={'02'} title={'Lock on targets'} description={"Select the muscles you want to workout."} />
            ...
            <Header index={'03'} title={'Reach your goals'} description={"Select your objective."} />
